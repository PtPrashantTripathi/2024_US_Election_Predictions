...
class App extends Component {
  constructor(props) {
    ...
    this.node_app_url = "http://localhost:8001/fixtures";
    this.state = {
      data: [],
      error: undefined,
      showModal: false,
  ...
  submitHandler = (e) => {
    ...
    fetch(this.node_app_url, requestOptions)
      ...
      <div className="app">
        <div className="app-body">
          ...
          <div className="footer-controls">
            {
              <Button className="success" onClick={this.showModalHandler}>
                Add
              </Button>
            }
          </div>
